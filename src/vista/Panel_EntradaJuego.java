...
public class Panel_EntradaJuego extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jl_TituloEntrada, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 60, 460, -1));
        ...
        add(jl_MejorPuntuacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 130, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 150, 380, 100));
        ...
        add(btn_Jugar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 280, 160, 50));
        ...
        add(btn_Salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 280, 160, 50));
        ...
        add(jl_CampoJuego, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, -1, -1));
        ...
        add(btn_AcercaDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 280, 160, -1));
        ...
        add(btn_Sonido, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 60, 50, 50));

        jcb_CampoJuego.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5", "6", "7" }));
        add(jcb_CampoJuego, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 200, 120, -1));

        jl_FondoEntrada.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/entradaJuego.jpg"))); // NOI18N
        add(jl_FondoEntrada, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1100, 440));
