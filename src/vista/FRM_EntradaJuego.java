...
public class FRM_EntradaJuego extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(panel_EntradaJuego1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1100, 450));
...
public class FRM_EntradaJuego extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        getContentPane().add(panel_EntradaJuego1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 359));
